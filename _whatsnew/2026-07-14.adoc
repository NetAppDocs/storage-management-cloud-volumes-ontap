...
The Cloud Volumes ONTAP 9.19.1 Release Candidate (RC) version is available in only  Google Cloud for upgrade to 9.19.1 General Availability (GA).
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-gcp.html[Deploy Cloud Volumes ONTAP with default values in Google Cloud^]
