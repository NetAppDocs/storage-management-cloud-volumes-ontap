...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-gcp.html[Deploy Cloud Volumes ONTAP with Quick create in Google Cloud^]
