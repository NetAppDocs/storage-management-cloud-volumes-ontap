...
For more information on AWS Local Zones with HA Deployments, refer to link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones[AWS Local Zones^].