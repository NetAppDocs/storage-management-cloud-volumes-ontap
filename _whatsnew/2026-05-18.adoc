...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-quick-deploy-azure.html[Deploy Cloud Volumes ONTAP with default values in Azure^]
