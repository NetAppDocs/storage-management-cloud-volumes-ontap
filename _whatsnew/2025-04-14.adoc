...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html[Manage data-serving storage VMs for Cloud Volumes ONTAP in Google Cloud^]