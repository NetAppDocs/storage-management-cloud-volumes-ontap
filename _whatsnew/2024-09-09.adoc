...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html[Enable NetApp ransomware protection solutions  for Cloud Volumes ONTAP]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html[WORM storage]