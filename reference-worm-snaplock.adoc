...
* For more information about WORM, refer to link:concept-worm.html[Learn about WORM storage on Cloud Volumes ONTAP].
* For information about charging of SnapLock volumes, refer to link:concept-licensing-charging.html[Licensing and charging in Cloud Volumes ONTAP].
