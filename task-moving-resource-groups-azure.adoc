...
. Remove the Cloud Volumes ONTAP system. Refer to link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html[Removing Cloud Volumes ONTAP systems]. 
