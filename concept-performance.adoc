...
+
link:https://www.netapp.com/pdf.html?item=/media/9088-tr4383.pdf[NetApp Technical Report 4383: Performance Characterization of Cloud Volumes ONTAP in Amazon Web Services with Application Workloads^]
endif::aws[]

ifdef::azure[]
* Cloud Volumes ONTAP for Microsoft Azure
+
link:https://www.netapp.com/pdf.html?item=/media/9089-tr-4671.pdf[NetApp Technical Report 4671: Performance Characterization of Cloud Volumes ONTAP in Azure with Application Workloads^]
endif::azure[]
...
//This topic is not in the sidebar because these TRs are outdated and not the links are breaking. It will be added back to the sidebar when the TRs are updated and the links are fixed.