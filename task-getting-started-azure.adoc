...
link:task-planning-your-config-azure.html[Plan your Cloud Volumes ONTAP configuration in Azure]

a| Set up your networking
a| Ensure your VNet and subnets support connectivity between the Console agent and Cloud Volumes ONTAP. Enable outbound internet access from the target VNet for NetApp AutoSupport.
a| Refer to this topic in this document:
link:reference-networking-azure.html[Networking requirements for Azure]

a| Launch Cloud Volumes ONTAP
a| Click *Add System*, select the type of system that you would like to deploy, and complete the steps in the wizard.
a| Refer to link:task-deploying-otc-azure.html[Launch Cloud Volumes ONTAP in Azure] in the Cloud Volumes ONTAP documentation
