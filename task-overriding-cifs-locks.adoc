...
You need to create a Console agent before you can change the Console settings. https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#how-to-create-a-connector[Learn how^].
