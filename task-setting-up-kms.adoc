...
. Search for the statement that enables access to the key `AllowUseOfTheKey` and append the Console agent role Amazon Resource Name (ARN) to the `Principal` array. Replace the placeholders in the following example with your values:
