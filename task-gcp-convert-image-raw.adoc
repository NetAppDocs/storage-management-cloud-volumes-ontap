...
NOTE: For more information on how to export an image through Google Cloud, refer to the https://cloud.google.com/compute/docs/images/export-image#console[Google Cloud doc on Exporting an image^].  