...
** You should have a https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html[Console agent that is associated with your system^].
...
. If you're prompted, https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-aws.html[create a Console agent^].
...
https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-aws-accounts.html[Learn how to add additional AWS credentials to NetApp Console^].
...
https://docs.netapp.com/us-en/bluexp-setup-admin/task-adding-aws-accounts.html[Learn how to add additional AWS credentials to the Console^].
...
+
* https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html[Learn more about NetApp Data Classification^]
* https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-to-s3.html[Learn more about Backup and Recovery^]
+
TIP: If you would like to utilize WORM and data tiering, you must disable Backup and Recovery and deploy a Cloud Volumes ONTAP system with version 9.8 or above. 
