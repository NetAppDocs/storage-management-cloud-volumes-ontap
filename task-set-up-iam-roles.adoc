...
summary: IAM roles with the required permissions must be attached to each Cloud Volumes ONTAP node. The same is true for the HA mediator. It's easiest to let the Console create the IAM roles for you, but you can use your own roles.
---
