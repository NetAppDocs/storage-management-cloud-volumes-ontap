...
[.lead]
Several licensing models are available for Cloud Volumes ONTAP. Each option enables you to choose a consumption model that meets your needs.

You have options to purchase or renew your licenses and subscriptions from cloud marketplaces or through NetApp (Bring-Your-Own License or BYOL). The marketplace offers you annual subscriptions and pay-as-you-go (PAYGO) options. For information, refer to link:concept-license-management.html[Learn more about capacity-based licenses for Cloud Volumes ONTAP].  

BYOL licenses are available for purchase from NetApp and can be used for any cloud provider. For more information about the availability of BYOL licenses, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap[Restricted availability of BYOL licensing for Cloud Volumes ONTAP^].

== Licensing overview

New customers can opt for charging through capacity-based annual marketplace subscriptions or Keystone subscriptions. Few deployments, such as those in private mode, also have the previous generation node-based BYOL licenses.

Capacity-based licensing::
Pay for multiple Cloud Volumes ONTAP systems in your NetApp account by provisioned capacity. Includes the ability to purchase add-on cloud data services. For more information about consumption models or purchase options in capacity-based licenses, refer to link:concept-licensing-charging.html[Learn more about capacity-based licenses].
...
ifdef::azure[]
* link:reference-configs-azure.html[Supported configurations in Azure] 
endif::azure[]
ifdef::gcp[]
* link:reference-configs-gcp.html[Supported configurations in Google Cloud^]
endif::gcp[]
...
+
NOTE: A pay-as-you-go (PAYGO) subscription is required for Backup and Recovery, however no charges will be incurred for using this service. For more information on setting up licensing for Backup and Recovery, refer to https://docs.netapp.com/us-en/data-services-backup-recovery/task-licensing-cloud-backup.html[Set up licensing for Backup and Recovery^].
* Add on any of NetApp's cloud data services at extra cost
...
https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap[Learn about Console agents^].

[NOTE]
NetApp has restricted the purchase, extension, and renewal of BYOL licensing. For more information, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap[Restricted availability of BYOL licensing for Cloud Volumes ONTAPP^].
...
[NOTE]
Private-mode deployments of Cloud Volumes ONTAP in private.
...
a| Valid node-based license purchased from NetApp or BYOL.
...
a| Expired BYOL node-based license. 
...
.Exceptions
NetApp recognizes that certain situations require special consideration, such as China region deployments of Cloud Volumes ONTAP in AWS, and EOA and EOS of node-based licensing might not apply to the following cases:
...
The Console enables a seamless conversion of node-based licenses to capacity-based licenses through the license conversion tool. For information about EOA of node-based licensing, refer to link:concept-licensing.html#end-of-availability-of-node-based-licenses[End of availability of node-based licenses].
...
##If you have marketplace subscriptions or private deployments with node-based licenses, you can link:task-convert-node-capacity.html[convert your node-based licenses to capacity based] using the license conversion tool in the Console.##
...
* link:task-manage-keystone.html[Manage Keystone subscriptions]