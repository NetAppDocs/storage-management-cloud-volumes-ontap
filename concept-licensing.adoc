...
New customers can opt for charging through capacity-based annual marketplace subscriptions or Keystone subscriptions. Few customers also have the previous generation node-based BYOL licenses.
