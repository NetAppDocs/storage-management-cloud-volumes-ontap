...
You have options to purchase or renew your licenses and subscriptions from cloud marketplaces or through NetApp (bring your own license (BYOL)). The marketplace offers you annual subscriptions and pay-as-you-go (PAYGO) options. For information, see link:concept-license-management.html[Learn more about capacity-based licenses for Cloud Volumes ONTAP].  
...
ifdef::azure[]
* link:link:reference-configs-azure.html[Supported configurations in Azure] 
endif::azure[]
ifdef::gcp[]
* link:link:reference-configs-gcp.html[Supported configurations in Google Cloud^]
endif::gcp[]
...
The Console enables a seamless conversion of node-based licenses to capacity based through the license conversion tool. For information about EOA of node-based licensing, refer to link:concept-licensing.html#end-of-availability-of-node-based-licenses[End of availability of node-based licenses].
