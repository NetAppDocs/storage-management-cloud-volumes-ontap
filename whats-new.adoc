...
== 28 August 2026
include::_whatsnew/2026-08-28.adoc[]
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-updating-ontap-cloud.html#patch-releases[Upgrade Cloud Volumes ONTAP^]
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-deploying-gcp.html[Launch Cloud Volumes ONTAP in Google Cloud^]
...
For more information on usage reports, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-capacity-licenses.html#download-usage-reports[Download usage reports^].
...
For more information, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-capacity-licenses.html[Manage capacity-based licenses^].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-volumes.html[Learn more about viewing created FlexGroup volumes.^] 
...
For detailed information on how to configure the placement group creation setting, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-configure-placement-group-failure-aws.html#overview[Configure placement group creation for AWS HA Single AZ^].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-enabling-private-link.html#provide-bluexp-with-details-about-your-azure-private-dns[Provide BlueXP with details about your Azure Private DNS^]
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-worm.html[Learn about WORM storage.^]
...
Refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html#packages[Cloud Volumes ONTAP licensing^].
...
For more information on the ONTAP feature licenses automatically installed with Cloud Volumes ONTAP, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/reference-default-configs.html[Default Configuration for Cloud Volumes ONTAP^].
...
For more information, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-moving-resource-groups-azure.html[Moving resource groups]. 
...
If you use a https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-licensing.html[capacity-based license^] for Cloud Volumes ONTAP, you are no longer charged for the capacity used by FlexClone volumes.
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-keystone.html[Learn how to get started with Keystone Subscriptions in BlueXP^].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-set-up-azure-encryption.html[Learn more about these steps].
...
Write once, read many (WORM) storage is no longer in Preview and is now available for general use with Cloud Volumes ONTAP. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-worm.html[Learn more about WORM storage].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-enabling-private-link.html[Learn more about using an Azure Private Link with Cloud Volumes ONTAP].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-tiering.html#changing-the-cooling-period-for-the-auto-tiering-policy[Learn how to adjust the minimum cooling period.]
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-planning-your-config.html[Size your system in AWS].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-getting-started-aws-c2s.html[Deploy Cloud Volumes ONTAP in AWS Secret Cloud or AWS Top Secret Cloud].
...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/reference-networking-gcp.html#requirements-for-cloud-volumes-ontap[Learn more about IP address requirements in Google Cloud].
