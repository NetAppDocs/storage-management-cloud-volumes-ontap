...
summary: Learn about new features and enhancements in Cloud Volumes ONTAP management.
---
...
== 02 September 2026
include::_whatsnew/2026-09-02.adoc[]

== 25 August 2026
include::_whatsnew/2026-08-25.adoc[]

== 10 August 2026
include::_whatsnew/2026-08-10-919.adoc[]

== 03 August 2026
include::_whatsnew/2026-08-03.adoc[]

== 23 July 2026
include::_whatsnew/2026-07-23.adoc[]

== 20 July 2026
include::_whatsnew/2026-07-20.adoc[]

== 14 July 2026
include::_whatsnew/2026-07-14.adoc[]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-saz-feature.html[Learn how to enable VMOrchestratorZonalMultiFD for single availability zones^].
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha-azure.html[Learn about high-availability pairs in Azure^].
...
For information about how BlueXP manages FlexCache volumes, refer to the https://docs.netapp.com/us-en/console-volume-caching/index.html[BlueXP volume caching documents^].
...
For more information on AWS Local Zones with HA Deployments, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha.html#aws-local-zones[AWS Local Zones^].
...
If required by your security policies, you can configure your EC2 instances to use IMDSv2. For instructions, refer to https://docs.netapp.com/us-en/console-setup-admin/task-require-imdsv2.html[BlueXP setup and administration documentation for managing existing Connectors^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9141-relnotes/[Learn about the new features included in this release of Cloud Volumes ONTAP^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-updating-ontap-cloud.html#patch-releases[Upgrade Cloud Volumes ONTAP^]
...
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-limits-aws.html#file-and-volume-limits[Storage limits in AWS]
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-limits-azure.html#file-and-volume-limits[Storage limits in Azure]
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-limits-gcp.html#logical-storage-limits[Storage limits in Google Cloud]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-9140-relnotes/[Learn about the new features included in this release of Cloud Volumes ONTAP^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-azure.html[View supported configurations for Cloud Volumes ONTAP in Azure^]
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-limits-azure.html[View storage limits for Cloud Volumes ONTAP in Azure^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploying-gcp.html[Launch Cloud Volumes ONTAP in Google Cloud^]
...
For more information on usage reports, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html#download-usage-reports[Download usage reports^].
...
To learn more about ARP with Cloud Volumes ONTAP, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-protecting-ransomware.html#autonomous-ransomware-protection[Autonomous Ransomware Protection^].
...
For more information, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html[Manage capacity-based licenses^].
...
These new AWS permissions have been added to the IAM policy for HA mediators in Cloud Volumes ONTAP high-availability (HA) environments:

* sts:AssumeRole
* ec2:DescribeSubnets

//This was added at the behest of Paul Vincent upon a lengthy discussion on issue NOC-35555. Manini: 11 Dec, 2025.NetApp Doc change history  - 2010496957  || AWS HA mediator IAM role changes || RCA
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html[Learn how to view the consumed capacity in your account^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-volumes.html[Learn more about viewing created FlexGroup volumes.^] 
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-encrypting-volumes.html[Learn how to encrypt volumes with NetApp encryption solutions^].
...
* https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-private-mode.html[Install the Connector in a location without internet access^]
+
* https://docs.netapp.com/us-en/console-setup-admin/task-logging-in.html[Access the BlueXP console on the Connector^]
+
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#manage-byol-licenses[Add an unassigned license^]
...
Learn more about https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html[supported configurations by license for Google Cloud^].
...
For detailed information on how to configure the placement group creation setting, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-configure-placement-group-failure-aws.html#overview[Configure placement group creation for AWS HA Single AZ^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html#provide-bluexp-with-details-about-your-azure-private-dns[Provide BlueXP with details about your Azure Private DNS^]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html[Learn about WORM storage.^]
...
Refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages[Cloud Volumes ONTAP licensing^].
...
For more information on the ONTAP feature licenses automatically installed with Cloud Volumes ONTAP, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-default-configs.html[Default Configuration for Cloud Volumes ONTAP^].
...
For more information, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-moving-resource-groups-azure.html[Moving resource groups]. 
...
For more information on this new functionality, refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html[Set up Cloud Volumes ONTAP to use a customer-managed key in Azure]. 
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-capacity-licenses.html[Learn how to change charging methods].
...
image:https://raw.githubusercontent.com/NetAppDocs/bluexp-cloud-volumes-ontap/main/media/screenshot-optimize-cost-performance.png["A screenshot of the Optimize Cost & Performance option that's available from the Canvas after you select a Cloud Volumes ONTAP system."]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages[Learn more about these licensing packages].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html[Learn more about support for Elastic Volumes in AWS].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-administer-advanced-view.html[Learn more about the Advanced View].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-aws-elastic-volumes.html[Learn more about support for Elastic Volumes].
...
Be sure to provide these permissions to each set of AWS credentials that you've added to BlueXP. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html[View the latest Connector policy for AWS^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-deploy-aws-shared-vpc.html[Learn how to deploy an HA pair in a shared subnet].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html[Learn more about Azure Private Link connections with Cloud Volumes ONTAP].
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html[Learn how to create data-serving storage VMs for Cloud Volumes ONTAP in Google Cloud]
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html[Learn more about licensing].

=== S3 Glacier Instant Retrieval

You can now store tiered data in the Amazon Simple Storage Service (Amazon S3) Glacier Instant Retrieval storage class.

https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-storage-class-for-tiered-data[Learn how to change the storage class for tiered data].
...
You can still connect to System Manager by entering the cluster management IP address in a web browser that has a connection to the Cloud Volumes ONTAP system. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-connecting-to-otc.html[Learn more about connecting to System Manager].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-create-volumes.html[Learn how to create volumes on a specific aggregate].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html[Learn more about the licensing options for Cloud Volumes ONTAP].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html#exchange-unassigned-node-based-licenses[Learn how to exchange unassigned node-based licenses].
...
If you use a https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html[capacity-based license^] for Cloud Volumes ONTAP, you are no longer charged for the capacity used by FlexClone volumes.
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-keystone.html[Learn how to get started with Keystone Subscriptions in BlueXP^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-set-up-azure-encryption.html[Learn more about these steps].
...
+
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html[Learn more about these licensing options].
+
...
Write once, read many (WORM) storage is no longer in Preview and is now available for general use with Cloud Volumes ONTAP. https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-worm.html[Learn more about WORM storage].
...
Be sure to provide these permissions to each set of Azure credentials that you've added to BlueXP. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html[View the latest Connector policy for Azure^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-enabling-private-link.html[Learn more about using an Azure Private Link with Cloud Volumes ONTAP].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-tiering.html#changing-the-cooling-period-for-the-auto-tiering-policy[Learn how to adjust the minimum cooling period.]
...
Note that a Connector requires a new permission to delete Azure snapshots. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html[View the latest Connector policy for Azure^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html[Size your system in AWS].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-getting-started-aws-c2s.html[Deploy Cloud Volumes ONTAP in AWS Secret Cloud or AWS Top Secret Cloud].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-setting-up-kms.html[Learn more about setting up the AWS KMS with Cloud Volumes ONTAP].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html#requirements-for-cloud-volumes-ontap[Learn more about IP address requirements in Google Cloud].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-gcp.html[Learn more about Google Cloud networking requirements].
...
Cloud Volumes ONTAP now supports 64 TB disks in Google Cloud.

NOTE: The maximum system capacity with disks alone remains at 256 TB due to Google Cloud limits.

=== New machine types in Google Cloud

Cloud Volumes ONTAP now supports the following machine types with these PAYGO licenses in Google Cloud:
