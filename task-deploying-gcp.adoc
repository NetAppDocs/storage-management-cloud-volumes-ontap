...
+
Learn more about https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-configs-gcp.html#flash-cache-support[Flash Cache^] and link:concept-write-speed.html[write speed].
+
