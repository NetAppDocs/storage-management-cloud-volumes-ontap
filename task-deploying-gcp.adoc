...
//| GCP Worker Pool |  For private deployments, you must select the link:reference-networking-gcp.html#infrastructure-manager-configurations-for-private-mode-deployments[worker pool] that you configured for your Cloud Volumes ONTAP system.
