...
+
[NOTE]
##If you select a single AZ deployment for Cloud Volumes ONTAP 9.19.1 or later, you can see preconfigured packages with C3-series machines and Hyperdisk Balanced disks. For earlier versions and multiple AZs, you can still select n2-standard machines and Persistent Disks.##
+
. *Licensing*: Change the Cloud Volumes ONTAP version as needed and select a machine type.
+
