...
| Edit Project a| Select the project where you want Cloud Volumes ONTAP to reside. 
...
. *Connectivity*: Select VPCs for the HA configuration, three for single AZ, and four for multiple AZ, and a subnet in each VPC, and then choose a firewall policy.
+
