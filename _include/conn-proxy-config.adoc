...
For information about configuring proxy servers, refer to the https://docs.netapp.com/us-en/console-setup-admin/task-configuring-proxy.html[Configure the Console agent to use a proxy server^]. 
