...
* If you haven't registered an NSS account in the Console, register an NSS account now and then the Digital Advisor UI appears. Refer to https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html[Manage NSS credentials associated with an organization or account] for the instructions.
