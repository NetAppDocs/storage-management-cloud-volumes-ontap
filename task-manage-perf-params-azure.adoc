...
Use the APIs to automate the process for modifying Premium SSD v2 disk settings. For information about running Cloud Volumes ONTAP API calls, refer to https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie[Your first API call^].
...
* https://docs.netapp.com/us-en/console-automation/platform/use_rest_apis.html[Use REST APIs for Cloud Volumes ONTAP^]
