...
https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html[Review the required shared VPC permissions covered in Console agent deployment^]
...
The Console agent also contacts several endpoints for day-to-day operations. For information about the endpoints, refer to https://docs.netapp.com/us-en/bluexp-setup-admin/task-install-connector-on-prem.html#step-3-set-up-networking[View endpoints contacted from the Console agent^] and https://docs.netapp.com/us-en/bluexp-setup-admin/reference-networking-saas-console.html[Prepare networking for using the Console^].
...
TIP: Looking for information about the Console agent? https://docs.netapp.com/us-en/bluexp-setup-admin/reference-ports-gcp.html[View firewall rules for the Console agent^]
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-google.html[View networking requirements for the Console agent^]
...
For information about configuring proxy servers for the Console agent, refer to the https://docs.netapp.com/us-en/bluexp-setup-admin/task-configuring-proxy.html[Configure a Console agent to use a proxy server^]. 
