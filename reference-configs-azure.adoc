...
For information about default configurations for Cloud Volumes ONTAP, refer to link:reference-default-configs.html[Supported default configurations for Cloud Volumes ONTAP].

== Internal disks for system data

In addition to the storage for user data, the NetApp Console also purchases cloud storage for system data in Azure.
