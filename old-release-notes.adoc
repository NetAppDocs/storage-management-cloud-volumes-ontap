---
sidebar: sidebar
permalink: old-release-notes.html
keywords: old release notes, old enhancements, what's new
summary: Review the enhancements to Cloud Volumes ONTAP from earlier releases here.
---

= Older enhancements in CLoud Volumes ONTAP
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Review the enhancements to Cloud Volumes ONTAP from earlier releases here.
