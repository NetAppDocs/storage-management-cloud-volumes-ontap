...
+
image:screenshot_features_machine_type.png[A screenshot that shows the Machine type setting under the Features panel available in the top right of the Overview page when viewing a system.] 
