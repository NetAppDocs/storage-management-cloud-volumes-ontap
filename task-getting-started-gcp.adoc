...
a| Cloud Volumes ONTAP requires a Google Cloud service account for enabling link:concept-data-tiering.html[data tiering] to tier cold data to low-cost object storage in Google Cloud, and also to enable the https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html[NetApp Backup and Recovery^] to back up volumes to low-cost object storage.
