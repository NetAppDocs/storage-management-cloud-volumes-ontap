...
These permissions are included in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-aws.html[the policies provided by NetApp^]
...
+
https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html[Learn how to set up data replication^]
