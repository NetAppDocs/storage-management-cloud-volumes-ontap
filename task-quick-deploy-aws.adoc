...
. A Console agent that's up and running. You should have a Console agent that is associated with your project or workspace. You should be prepared to leave the Console agent running at all times.
+
[role="tabbed-block"]
====
.For AWS, refer to
