...
== Charging and supported configurations in capacity-based licenses
...
== Charging for read/write volumes
...
You can select the method by which you want to be charged in the *Licenses and subscriptions* section in the Console. Overages are charges incurred when you exceed the specified capacity for your license package or annual subscription. You can choose from the following billing methods:

* *NetApp licenses first, marketplace subscriptions for extra usage*: In this model, your consumption is charged against the specified capacity of your license package (BYOL), with a preference for using available capacity from other licenses first. If you exceed your licenses capacity, you'll be charged for overages based on your annual marketplace subscription or marketplace on-demand hourly rates (PAYGO). If your BYOL license expires, you need to transition to a capacity-based licensing model through cloud marketplaces.
* *Marketplace subscriptions only*: In this model, your consumption is charged first against your annual marketplace subscription. For any additional usage, you'll be charged at marketplace on-demand hourly rates (PAYGO).
...
.##Essentials charging with BYOL or marketplace contracts/private offers##
##If you purchase multiple Essentials licenses from NetApp (BYOL) and exceed the committed capacity for a deployment and volume type, the Console first consumes any available capacity from a higher-priced Essentials license that you have already purchased, before charging against the marketplace. After that capacity is exhausted, the remaining overage is billed at marketplace on-demand (PAYGO) hourly rates and added to your monthly bill.##

##If you purchase multiple Essentials licenses through a marketplace contract or private offer, and exceed the committed capacity for a deployment and volume type, the Console first consumes any available capacity from a higher-priced Essentials license. After that capacity is exhausted, the remaining overage is billed at marketplace on-demand (PAYGO) hourly rates and added to your monthly bill.##
