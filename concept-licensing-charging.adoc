...
If you create or use a writable (read/write) volume, they are considered as primary volumes and charged based on their minimum capacity. Examples include any FlexVol primary volumes, SnapLock audit volumes,  data protection (DP) volumes, and CIFS audit volumes. All data-storing volumes that you create are charged based on your subscription and package. ONTAP-internal volumes that are automatically created and inaccessible to you are not charged.
