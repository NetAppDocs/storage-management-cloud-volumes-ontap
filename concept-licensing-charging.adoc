...
For information about converting node-based licenses to capacity-based, refer to link:task-convert-node-capacity.html[Convert a node-based license to a capacity-based license]. 
