...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-managing-svms-gcp.html[Learn how to create additional storage VMs^].
...
https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-ha-google-cloud.html[Learn how storage works in a Cloud Volumes ONTAP HA pair running in Google Cloud^].