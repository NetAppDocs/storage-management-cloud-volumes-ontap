...
+
[NOTE]
The existing inactive data maintains the default storage class when you change the storage class. To change the storage class for existing inactive data, refer to https://docs.cloud.google.com/storage/docs/managing-lifecycles[Google Cloud documentation: Managing object lifecycles^].     
+
