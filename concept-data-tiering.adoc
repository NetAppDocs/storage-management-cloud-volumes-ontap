...
[NOTE]
When a replication relationship is deleted, the destination volume retains the tiering policy that was in effect during replication. It does not revert to a default policy.
