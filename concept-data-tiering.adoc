...
[NOTE]
When a replication relationship is deleted, the destination volume retains the tiering policy that was in effect when the relationship was established. It does not revert to a default policy.
