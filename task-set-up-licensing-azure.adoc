...
Select the Freemium offering to use Cloud Volumes ONTAP free of charge with up to 500 GiB of provisioned capacity. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages[Learn more about the Freemium offering^].
...
+
You won't be charged through the marketplace subscription unless you exceed 500 GiB of provisioned capacity, at which time the system is automatically converted to the link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing[Essentials package^].
+
image:screenshot-azure-paygo-subscription.png[A screenshot of the PAYGO subscription option when creating a Cloud Volumes ONTAP system.]
...
+
Your license must be available from the Console before you can use it with Cloud Volumes ONTAP. If needed, you can link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console[manually add the license to the Console].
...
TIP: You can manage the Azure Marketplace subscriptions associated with your Azure accounts from the Settings > Credentials page. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html[Learn how to manage your Azure accounts and subscriptions^]
...
. mailto:ng-keystone-success@netapp.com[Contact NetApp] to authorize your user account in the Console with one or more Keystone Subscriptions.
