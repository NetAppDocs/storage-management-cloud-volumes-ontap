...
. Click the image:icon-action.png["An icon that shows three horizontal dots for additional actions"] icon for the required Console agent and select *Edit Console agent*.
...
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html[Learn about cluster administration with ONTAP System Manager^]
