...
* https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html[Adding NetApp Support Site accounts to the Console^]
* link:task-registering.html[Register pay-as-you-go systems]

NOTE: The NetApp Console doesn't install the NVE license on systems that reside in the China region.
