...
a| Refer to this topic in this document:
link:task-planning-your-config.html[Plan your configuration]

a| Set up your networking
a| Ensure your VPC and subnets support connectivity between the Console agent and Cloud Volumes ONTAP. Enable outbound internet access for AutoSupport, and set up a VPC endpoint to Amazon S3 for data tiering.
a| Refer to this topic in this document:
link:reference-networking-aws.html[Networking requirements for AWS]
...
a| Refer to this topic in this document:
link:task-setting-up-kms.html[Set up the AWS KMS]
...
a| Refer to link:task-deploying-otc-aws.html[Launch Cloud Volumes ONTAP in AWS] in the Cloud Volumes ONTAP documentation
