...
. If you enabled Backup and Recovery on the system, determine whether the backed up data is still required and then https://docs.netapp.com/us-en/data-services-backup-recovery/prev-ontap-backup-manage.html#delete-backups[delete the backups, if necessary^].
+
...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance[Learn more about the Data Classification instance^].
...
.. On the upper right of the Console, click the image:icon-action.png["An icon that shows three horizontal dots for additional actions"] icon, and select *Delete*.
