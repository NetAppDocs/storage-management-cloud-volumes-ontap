...
* A free license for Cloud Volumes ONTAP is provided for up to 500 GiB of provisioned capacity, with no NetApp support and no expiry date. Capacity beyond 500 GiB requires a valid licensing entitlement and may incur charges. To access the full Cloud Volumes ONTAP experience and advanced management capabilities, connect your Cloud Volumes ONTAP system to NetApp Console. Discovery and management through NetApp Console require a valid Azure Marketplace subscription associated with your NetApp Console account. 
...
.Before you begin
* If you plan to discover and manage the deployed system in NetApp Console, ensure that the NetApp Console account is associated with a valid Azure Marketplace subscription. Discovery of the system into NetApp Console requires a valid subscription.
...
* https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-subscriptions.html[Add a new marketplace subscription^]
