...
.Before you begin
* If you plan to discover and manage the deployed system in the Console, ensure that the Console account is associated with a valid Azure Marketplace subscription. Discovery of the system into the Console requires a valid subscription.
