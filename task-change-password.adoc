...
. On the upper right of the Console, click the image:icon-action.png["An icon that shows three horizontal dots for additional actions"] icon, and select *Set password*.
+
