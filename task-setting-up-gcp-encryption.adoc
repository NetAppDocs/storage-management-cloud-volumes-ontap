...
+
The permissions are provided in the https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html[the service account permissions by default^], but may not be applied if you use an alternate project for the Cloud Key Management Service.
+
...
Refer to the https://docs.netapp.com/us-en/console-automation/index.html[NetApp Console automation docs^] for more details about using the "GcpEncryption" parameter.
