...
[%collapsible]
====
* Ensure that you have the latest https://docs.netapp.com/us-en/console-setup-admin/concept-agents.html#agent-upgrades[Console agent version^] before conversion to use Infrastructure Manager APIs.
