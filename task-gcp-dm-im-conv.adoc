...
= Convert existing Cloud Volumes ONTAP deployments to Google Infrastructure Manager
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
[NOTE]
If you are running the tool in private mode, add the `cloudbuild.workerpools.get` permission also to the YAML file.
