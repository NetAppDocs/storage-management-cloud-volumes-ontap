...
summary: You can deploy Cloud Volumes ONTAP in AWS Secret Cloud and Top Secret Cloud environments. AWS Secret Cloud and Top Secret Cloud regions are closed regions specific to the U.S. Intelligence Community. The instructions on this page only apply to AWS Secret Cloud and Top Secret Cloud region users.
---
...
+
To learn more about how private mode works, refer to link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode[the private deployment mode in the Console^]. 
