...
The Console agent requires specific permissions to create storage VMs for Cloud Volumes ONTAP. The required permissions are included in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html[the policies provided by NetApp^].
...
The Console agent requires specific permissions to manage storage VMs for Cloud Volumes ONTAP. The required permissions are included in https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html[the policies provided by NetApp^].
