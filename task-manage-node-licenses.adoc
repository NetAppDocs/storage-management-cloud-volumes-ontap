...
Marketplace subscriptions are not supported for node-based licensing. You can manage node-based Cloud Volumes ONTAP licenses licenses from the NetApp Console.
