...
** You should have a https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[Console agent that is associated with your system^].
...
. If you're prompted, https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[create a Console agent^].
...
TIP: If the Azure account that you're using has the https://docs.netapp.com/us-en/bluexp-setup-admin/reference-permissions-azure.html[required permissions^], the Console removes Cloud Volumes ONTAP resources from a resource group, in case of deployment failure or deletion.
