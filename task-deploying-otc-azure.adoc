...
+
This option is only available for certain VM types. To find out which VM types are supported, refer to link:reference-configs-azure.html#ha-pairs[Supported configurations by license for HA pairs]. 
+
...
+
link:reference-configs-azure.html#ha-pairs[Learn more about supported configurations in Azure^].
