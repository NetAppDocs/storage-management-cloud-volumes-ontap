...
Beginning with ONTAP version 9.12.1, NVMe-TCP is supported for cloud providers. ##Cloud Volumes ONTAP supports NVMe-TCP as a block protocol for storage VMs (SVMs) during deployment, and installs the required NVMe licenses automatically.##
