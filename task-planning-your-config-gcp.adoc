...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/reference-limits-gcp.html[Storage limits for Cloud Volumes ONTAP in Google Cloud^]
...
+
For more details, refer to the https://cloud.google.com/compute/docs/disks/#pdspecs[Google Cloud documentation: Zonal Persistent disks (Standard and SSD)^].
...
* link:reference-configs-gcp.html#google-cloud-single-node[View the default disks for Cloud Volumes ONTAP system data in Google Cloud].
* https://docs.cloud.google.com/docs/quotas/overview[Google Cloud docs: Cloud Quotas overview^]
+
...
TIP: The Console agent also requires a system disk. https://docs.netapp.com/us-en/console-setup-admin/reference-connector-default-config.html[View details about the Console agent's default configuration^].
