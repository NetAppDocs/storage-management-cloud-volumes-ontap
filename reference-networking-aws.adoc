...
TIP: Looking for information about the Console agent? https://docs.netapp.com/us-en/bluexp-setup-admin/reference-ports-aws.html[View security group rules for the Console agent^]
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/concept-install-options-aws.html[View networking requirements for the Console agent^]
