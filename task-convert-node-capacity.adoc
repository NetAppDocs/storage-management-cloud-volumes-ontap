...
[NOTE]
##If you have private mode Cloud Volumes ONTAP deployments, you can transition your existing BYOL node-based licenses to the Essentials package using the license conversion tool in the NetApp Console. This lets you retain the benefits of capacity-based licensing within the BYOL model without requiring marketplace subscriptions.##
...
* ##For private mode, you can convert any node-based license to the Essentials package. For example, if you have a BYOL Standard node-based license, you can convert it to a BYOL Essentials package. The conversion from node-based licenses to the Professional package is not supported for private mode.## 
