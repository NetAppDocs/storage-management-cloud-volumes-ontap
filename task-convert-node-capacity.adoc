...
* *Private mode deployments*: Private mode Cloud Volumes ONTAP deployments don't support marketplace subscriptions. As a result, you can only convert node-based licenses to capacity-based Essentials packages using BYOL licensing through the license conversion tool in the NetApp Console. This approach allows you to retain the benefits of capacity-based licensing within the BYOL model. Before conversion, you should have a capacity-based Essentials package that corresponds to your node-based license type. For example, to convert a BYOL Secondary HA node-based license, you should already have an Essentials Secondary HA package available in your account. After conversion, the entire capacity of your node-based license is tracked under the Essentials package, and you continue to be billed through your BYOL agreement. Conversion to other capacity-based licenses, such as Professional packages, is not supported in private mode.
...
* link:concept-licensing-charging.html[Learn more about capacity-based licenses]
...
* link:task-convert-node-capacity.html[Convert a node-based license to a capacity-based license]
