...
= Learn about write speed on Cloud Volumes ONTAP
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
link:reference-configs-aws.html[Learn more about the Amazon EC2 instances that Cloud Volumes ONTAP supports].
endif::aws[]
...
If you use an HA pair, Cloud Volumes ONTAP supports high write speed with several VM types, starting with the 9.8 release. Go to the link:reference-configs-azure.html[Cloud Volumes ONTAP Release Notes] to view the VM types that support high write speed.
endif::azure[]
...
If you use an HA pair, Cloud Volumes ONTAP supports high write speed with several VM types, starting with the 9.13.0 release. Go to the link:reference-configs-gcp.html#supported-configurations-by-license[Cloud Volumes ONTAP Release Notes^] to view the VM types that support high write speed.

link:reference-configs-gcp.html[Learn more about the Google Cloud machine types that Cloud Volumes ONTAP supports^].
endif::gcp[]
