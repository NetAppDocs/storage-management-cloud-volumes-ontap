...
+
Refer to https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-azure-download-digest-file.html[Download the Azure image digest file^] for more information.
