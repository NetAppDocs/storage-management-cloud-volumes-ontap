...
+
link:reference-security-groups.html[Refer to the security group rules for Cloud Volumes ONTAP]. Note that you don't need to create a security group for the HA mediator. The Console does that for you.
...
. Use the API to create a new Cloud Volumes ONTAP system.
+
...
+
https://docs.netapp.com/us-en/console-automation/cm/overview.html[Learn about the Cloud Volumes ONTAP API^]
